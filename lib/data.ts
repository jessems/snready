...
import cisDiscoveryTopics from "@/data/topics/cis-discovery-topics.json";
import cisCsmTopics from "@/data/topics/cis-csm-topics.json";
import cisHamTopics from "@/data/topics/cis-ham-topics.json";
import cisVrTopics from "@/data/topics/cis-vr-topics.json";
import cisSirTopics from "@/data/topics/cis-sir-topics.json";
import cisSpTopics from "@/data/topics/cis-sp-topics.json";
...
const topicsMap: Record<string, any> = {
  ...
  "cis-discovery": cisDiscoveryTopics,
  "cis-csm": cisCsmTopics,
  "cis-ham": cisHamTopics,
  "cis-vr": cisVrTopics,
  "cis-sir": cisSirTopics,
  "cis-sp": cisSpTopics,
